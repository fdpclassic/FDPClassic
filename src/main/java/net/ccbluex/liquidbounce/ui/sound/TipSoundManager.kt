...
class TipSoundManager {
    ...
    init {
        ...
        val JelloEnableSoundFile = File("assets/minecraft/fdpclient/sound/jello/enable.wav")
        val JelloDisableSoundFile = File("assets/minecraft/fdpclient/sound/jello/disable.wav")
